...
and every one of its 34 domain headers. Every top-level function and public
...
`api_manifest.json` inventories 891 bound top-level functions/types.
`header_audit.json` records SHA-256 digests for the umbrella and all 36
