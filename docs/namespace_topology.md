...
|-- ida::decompiler     Decompile, pseudocode/microcode, ctree, events/cache/helpers [9 enums, 8 structs, 8 classes, ~11 free fns]
...
| `ida::decompiler` | Decompilation | `DecompiledFunction` (pseudocode+microcode), `DecompileFailure`, `MaturityEvent`, `MicrocodeValue`, `MicrocodeValueLocation`, `MicrocodeCallOptions`, `MicrocodeFilter`, `MicrocodeContext`, `ScopedSubscription`, `ScopedMicrocodeFilter` |
