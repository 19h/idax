...
| `ida::type` | Type system, including copied shifted-pointer metadata, metadata-preserving pointer/prototype edits, and UDT semantic mutation | `TypeInfo`, `PointerDetails`, `TypeKind`, `EnumRadix`, `Member`, `FunctionDetails`, `EnumDetails`, `UdtDetails` |
