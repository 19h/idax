...
|-- ida::decompiler     Decompile, pseudocode/microcode, ctree, events/cache/helpers [7 enums, 6 structs, 8 classes, ~11 free fns]
...
| `ida::decompiler` | Decompilation | `DecompiledFunction` (pseudocode+microcode), `DecompileFailure`, `MaturityEvent`, `MicrocodeValue`, `MicrocodeCallOptions`, `MicrocodeFilter`, `MicrocodeContext`, `ScopedSubscription`, `ScopedMicrocodeFilter` |
