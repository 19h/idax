...
|-- ida::decompiler     Decompile, pseudocode/microcode, ctree, events/cache helpers [4 enums, 4 structs, 5 classes, ~8 free fns]
...
| `ida::decompiler` | Decompilation | `DecompiledFunction` (pseudocode+microcode), `DecompileFailure`, `MaturityEvent`, `CtreeVisitor`, `ScopedSubscription` |
