...
|-- ida::decompiler     Decompile, pseudocode/microcode, ctree, events/cache/helpers [10 enums, 9 structs, 8 classes, ~11 free fns]
...
| `ida::decompiler` | Decompilation | `DecompiledFunction` (pseudocode+microcode), `DecompileFailure`, `MaturityEvent`, `MicrocodeValue`, `MicrocodeLocationPart`, `MicrocodeValueLocation`, `MicrocodeCallOptions`, `MicrocodeFilter`, `MicrocodeContext`, `ScopedSubscription`, `ScopedMicrocodeFilter` |
