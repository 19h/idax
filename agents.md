...
6. Prioritize post-P0/P1/P2 additive decompiler write-path depth for lifter-class ports: extend beyond baseline generic instruction emission + typed-emitter placement controls + callinfo role/return-location hinting into richer typed IR value/argument/call builders (advanced vector/UDT semantics + deeper callinfo/tmop semantics + placement parity for additional emission paths).
