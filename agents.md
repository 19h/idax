...
5. Evaluate remaining additive APIs surfaced by the ida2py port audit (`docs/port_gap_audit_ida2py.md`): typed-value materialization and optional Appcall/executor abstractions.
