...
4. Prioritize additive API design for the remaining external-port gaps documented in `docs/port_gap_audit_ida_qtform_idalib_dump.md` (decompiler microcode/failure-detail surfaces, headless plugin policy controls, Lumina facade).
