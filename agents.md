...
6. Prioritize post-P0 additive decompiler write-path depth for lifter-class ports: extend beyond the new baseline generic instruction emitter into richer typed IR value/argument/call builders (advanced vector/UDT semantics + advanced callinfo/tmop semantics + deterministic placement controls).
