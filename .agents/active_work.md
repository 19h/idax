...
- **10.1. P58.4 validation and closure**
  ...
  - 10.1.7. **Windows replacement status:** Run 29471023737 installs IDA 9.4 but the Unicode selector subprocess regression inherits CP1252 and fails before child launch. The explicit UTF-8 byte-boundary fix and positive CLI regression are active under F525; another exact replacement run is required.
