...
- **10.2. End-to-end implementation**
  ...
  - 10.2.3. **Status:** P57.7 active. Exact run 29448198064 is green in 8/9 jobs, including strict compatible-host decompiler execution on Linux and macOS; Windows alone exposed checkout-EOL sensitivity after a successful native build (F506; KB 35.159). The canonical digest regression and single-build workflow correction pass locally; exact review and replacement cross-platform CI remain.
