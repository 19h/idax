...
- **7.1. HCLI License Selection Defect**
  ...
  - 7.1.4. **Status:** P55.1-P55.2 complete with live install/masking evidence; SDK/runtime alignment passes and P55.3 is active on independently exposed C++/Node/Rust cross-platform compiler/generator failures (F472-F474; KB 35.128-35.130), with no external blocker.
