...
### 7. Opaque IDC Value and Script Execution (Phase 71)

- **7.1. Exact Semantics and Value-Lifetime Falsification**
  - 7.1.1. **Action:** Probe exact IDA 9.4 scalar/object copy, conversion, attributes, slices, compile/evaluate/call/snippet/script errors, exception results, and database-lifetime behavior.
  - 7.1.2. **Scope:** Caller-owned value and synchronous execution operations only; external IDC functions and external-language registration remain separate callback-lifecycle phases.
