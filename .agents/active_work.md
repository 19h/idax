...
- **7.1. HCLI License Selection Defect**
  ...
  - 7.1.4. **Status:** P55.1-P55.2 complete with live install/masking evidence; P55.3 is active on the independently exposed SDK/runtime version-alignment failure (F470; KB 35.126), with no external blocker.
