...
### 7. Opaque Exception-Region Domain (Phase 61)

- **7.1. Release Validation and Closure**
  - 7.1.1. **Active:** Run the complete exact-SDK native/binding/package/privacy regression and self-red-team for the completed five-operation exception-region implementation.
  - 7.1.2. **Next:** Exact staged review, commit, push `master`, verify live CI and log privacy, add closure records, check P61.4, and remove this completed Phase 61 section.
  - 7.1.3. **Blocker:** None.
  - 7.1.4. **Status:** P61.4 in progress.
