...
ida::Status show_gap_report() {
    ida::ui::message(
        "[lifter-port] Confirmed parity gaps for full <userhome>/dev/lifter port:\n"
        "  1) Microcode filter/hooks + scalar/byte-array/vector helper-call modeling/location hints are present, but\n"
